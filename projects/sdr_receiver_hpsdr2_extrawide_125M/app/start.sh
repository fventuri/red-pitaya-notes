...
cat $apps_dir/sdr_receiver_hpsdr2_extrawide_125M/sdr_receiver_hpsdr2_extrawide_125M.bit > /dev/xdevcfg
...
$apps_dir/sdr_receiver_hpsdr2_extrawide_125M/sdr-receiver-hpsdr2 \
  0 0 0 0 &
