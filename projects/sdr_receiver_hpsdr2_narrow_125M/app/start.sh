...
cat $apps_dir/sdr_receiver_hpsdr2_narrow_125M/sdr_receiver_hpsdr2_narrow_125M.bit > /dev/xdevcfg
...
$apps_dir/sdr_receiver_hpsdr2_narrow_125M/sdr-receiver-hpsdr2 \
