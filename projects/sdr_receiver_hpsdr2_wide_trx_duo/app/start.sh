...
cat $apps_dir/sdr_receiver_hpsdr2_wide_trx_duo/sdr_receiver_hpsdr2_wide_trx_duo.bit > /dev/xdevcfg
...
$apps_dir/sdr_receiver_hpsdr2_wide_trx_duo/sdr-receiver-hpsdr2 \
  0 0 0 0 0 0 &
