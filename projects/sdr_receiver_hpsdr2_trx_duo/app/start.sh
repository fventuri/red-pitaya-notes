...
cat $apps_dir/sdr_receiver_hpsdr2_trx_duo/sdr_receiver_hpsdr2_trx_duo.bit > /dev/xdevcfg

# Per-DDC ADC assignment (DDC0..7): 0 = host chooses the ADC (e.g. linhpsdr/Thetis ADC
...
$apps_dir/sdr_receiver_hpsdr2_trx_duo/sdr-receiver-hpsdr2 \
  0 0 0 0 0 0 0 0 &
