...
module rx_0 {
  source projects/sdr_transceiver_hpsdr_trx_duo/rx.tcl
} {
...
module tx_0 {
  source projects/sdr_transceiver_hpsdr_trx_duo/tx.tcl
} {
...
module codec {
  source projects/sdr_transceiver_hpsdr_trx_duo/codec.tcl
} {
