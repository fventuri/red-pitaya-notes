...
cat $apps_dir/sdr_transceiver_hpsdr_125M/sdr_transceiver_hpsdr_125M.bit > /dev/xdevcfg

$apps_dir/sdr_transceiver_hpsdr_125M/sdr-transceiver-hpsdr 1 2 2 2 1 2 &
