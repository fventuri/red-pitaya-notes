...
linux_dir=tmp/linux-6.15
linux_ver=6.15.1-xilinx
...
zip -r red-pitaya-alpine-3.22-armv7-`date +%Y%m%d`-$project.zip apps boot.bin cache modloop trx-duo.apkovl.tar.gz start.sh wifi
